...
def upgrade():
    ...
    op.create_table('kronos_gateway',
    ...
    op.create_index(op.f('ix_kronos_gateway_hid'), 'kronos_gateway', ['hid'], unique=False)
    op.create_table('kronos_device',
    sa.Column('hid', sa.Text(), nullable=False),
    sa.Column('name', sa.Text(), nullable=False),
    sa.Column('uid', sa.Text(), nullable=False),
    sa.Column('type', sa.Text(), nullable=False),
    ...
    sa.ForeignKeyConstraint(['gatewayHid'], ['kronos_gateway.hid'], ),
    sa.PrimaryKeyConstraint('hid')
    )
    op.create_index(op.f('ix_kronos_device_hid'), 'kronos_device', ['hid'], unique=False)
    ...
    op.create_table('kronos_device_sensors',
    sa.Column('device_hid', sa.Text(), nullable=False),
    sa.Column('timestamp', sa.Integer(), nullable=False),
