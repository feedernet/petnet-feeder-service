...
class ScheduleModalContainer extends React.Component {
    ...
    componentDidUpdate(prevProps, prevState, snapshot) {
        ...
        if (!prevProps.scheduleModalState.show && this.props.scheduleModalState.show) {
    ...
    handleSubmit(values, actions) {
        ...
        if (this.state.newEvent) {
            this.props.dispatchCreatePetSchedule(
            ...
            this.props.dispatchUpdatePetSchedule(
                this.props.scheduleModalState.pet.id,
...
const ScheduleModal = withRouter(connect(
    (state) => {
        ...
        return {
            ...
            dispatchUpdatePetSchedule(petId, eventId, name, time, portion, enabled) {
                return dispatch(updatePetScheduleAction(petId, eventId, name, time, portion, enabled))
            },
