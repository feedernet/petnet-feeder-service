...
class FeederCardListContainer extends React.Component {
    ...
    render() {
        const header = <h2 style={{marginBottom: 20}} className={"d-none d-sm-block"}>Feeders</h2>
                        ...
                        <Card style={{marginBottom: 20}} bg={'light'} text={'dark'}>
                            <Card.Body>
                                <div style={{display: "flex", justifyContent: "center"}}>
                                    <Spinner animation={"border"} role={"status"} size={"sm"} className={"mt-1 mx-2"}>
                                        <span className={"sr-only"}>Searching...</span>
                                    </Spinner>
                                    <p className={"font-weight-bold mb-0"} style={{display: "inline-block"}}>
                                        Waiting for New Devices
                                    </p>
                                </div>
                                <p className={"text-center text-muted mt-1 mb-0"}>
                                    Having trouble connecting your feeder? Check out the <a
                                    className={"text-secondary"}
                                    href={"https://github.com/feedernet/petnet-feeder-service/wiki/Getting-Started#getting-your-feeder-to-communicate"}>
                                    Getting Started
                                </a> guide on the FeederNet Wiki.
                                </p>
                            </Card.Body>
                        </Card>
                }
