...
class HopperLevelIndicatorContainer extends React.Component {
    ...
    componentDidUpdate(prevProps, prevState, snapshot) {
        const new_level = this.props.getHopperLevelState.levels[this.props.deviceHid]
    ...
    render() {
        return <HopperLevelIndicatorComponent level={this.state.level} animated={this.state.isLoading}/>
    }
}
...
const HopperLevelIndicator = withRouter(connect(
    (state) => {
