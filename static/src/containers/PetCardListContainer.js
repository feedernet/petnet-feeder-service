...
class PetCardListContainer extends React.Component {
    ...
    render() {
        const header = <h2 style={{marginBottom: 20}} className={"d-none d-sm-block"}>Pets</h2>
                        ...
                        <Card style={{marginBottom: 20}} bg={'light'} text={'dark'}>
                            <Card.Body>
                                ...
                                <p className={"text-center text-muted m-0"}>
                                    Once you have added a pet, you can assign it a feeder,
                                    create a schedule, and view their feed history.
                                </p>
                            </Card.Body>
                        </Card> :
                        null
