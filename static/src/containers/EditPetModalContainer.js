...
class EditPetModalContainer extends React.Component {
    ...
    handleDelete() {
        this.props.dispatchDeletePet(this.props.editPetModalState.pet.id).then(() => {
    ...
    render() {
        ...
        let transformedValues = {
            ...
            birthday: new Date(initialValues.birthday / 1000).toLocaleDateString("en-US"),
            image: initialValues.image
        }
        return <>
            <EditPetModalComponent
                show={this.props.editPetModalState.show && !this.state.showConfirmDelete}
            ...
            <Modal show={this.state.showConfirmDelete} onHide={() => this.setState({showConfirmDelete: false})} centered>
                ...
                <Modal.Footer>
                    <Button variant="danger" onClick={this.handleDelete} style={{width: "100%"}}>
...
const EditPetModal = withRouter(connect(
    (state) => {
        ...
        return {
            ...
            dispatchModifyPet(pet_id, name, animal_type, weight, birthday, activity_level, image, device_hid) {
