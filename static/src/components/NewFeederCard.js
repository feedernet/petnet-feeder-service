            ...
            <Card.Body>
                <Container>
                    <Row style={{alignItems: "center"}}>
                        ...
                        <Col md={12} lg={10}>
                            <h2 className={"text-center text-light font-weight-bold"}>We found a new feeder! 🎉</h2>
                            <h6 className={"text-center text-light my-3"}>There are just few quick steps before we get going.</h6>
                            <Button
                                variant={"primary"}
                                style={{marginRight: "auto", marginLeft: "auto", display: "block"}}
                                onClick={props.showNewFeederWizard}
                            >
                                <Icon path={mdiArrowRightCircle} size={.75}/> Setup New Feeder
                            </Button>
                        </Col>
                    </Row>
                </Container>
