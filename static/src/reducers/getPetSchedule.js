import {getPetSchedule, updatePetSchedule, deletePetSchedule, createPetSchedule} from "../constants/pet";

const getPetScheduleReducer = (state = {_loading: false, _requestFailed: false, schedules: {}}, action) => {
    switch (action.type) {
